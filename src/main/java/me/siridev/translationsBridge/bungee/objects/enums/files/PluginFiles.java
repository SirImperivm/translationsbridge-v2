package me.siridev.translationsBridge.bungee.objects.enums.files;

import me.siridev.translationsBridge.bungee.assets.utils.Formatter;
...
public enum PluginFiles {
    ...
    SETTINGS(getBungee().getConfigHandler().PluginFiles.get("settings")),
    MESSAGES(getBungee().getConfigHandler().PluginFiles.get("messages")),
    ;
